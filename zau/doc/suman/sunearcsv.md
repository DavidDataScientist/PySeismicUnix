...
SUNEARCSV - Assign Trace Key Values From Nearest Q-file Record. sunearcsv [parameters]. Parameters:

## Synopsis

```bash
sunearcsv type>0 dimensions, but restricted by ranges of type<0 dimension(s).
```
