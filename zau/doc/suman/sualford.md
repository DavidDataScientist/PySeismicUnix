...
SUALFORD - trace by trace Alford Rotation of shear wave data volumes sualford inS11=file1 inS22=file2 inS12=file3 inS21=file4

## Synopsis

```bash
sualford taper =>1, for use of cosine scale to
```
