...
SUKDMIG2D - Kirchhoff Depth Migration of 2D poststack/prestack data sukdmig2d  infile=  outfile=  ttfile=   [parameters]

## Synopsis

```bash
sukdmig2d infile=stdin		file for input seismic traces
```
