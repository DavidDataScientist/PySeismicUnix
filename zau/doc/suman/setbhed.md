...
```bash
setbhed segyread tape=yourdata.segy bfile=yourdata.b > yourdata.su
```
...
wrong byte order. You will need to use "swapbhed" to change the byte, order before applying this program.
