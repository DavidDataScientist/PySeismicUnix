...
SUTOOLCSV - Tools for Comma Separated Values and fixed text files. sutoolcsv rfile=inx.txt wfile=outx.txt setid=x match=sps2 names=sps2 forms=sps2

## Synopsis

```bash
sutoolcsv To output this documentation:   2> tooldoc.txt
```
