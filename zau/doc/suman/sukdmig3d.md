...
SUKDMIG3D - Kirchhoff Depth Migration of 3D poststack/prestack data sukdmig3d datain= dataout= [parameters]

## Synopsis

```bash
sukdmig3d datain=stdin	 file for input seismic traces
```
