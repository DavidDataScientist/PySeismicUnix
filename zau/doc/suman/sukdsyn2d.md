...
SUKDSYN2D - Kirchhoff Depth SYNthesis of 2D seismic data from a migrated seismic section sukdsyn2d  infile  outfile [parameters]

## Synopsis

```bash
sukdsyn2d infile=stdin		input migrated section
```
