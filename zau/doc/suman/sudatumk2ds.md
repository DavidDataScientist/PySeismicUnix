...
SUDATUMK2DS - Kirchhoff datuming of sources for 2D prestack data (input data are receiver gathers) sudatumk2ds  infile=  outfile=  [parameters]

## Synopsis

```bash
sudatumk2ds infile=stdin		file for input seismic traces
```
