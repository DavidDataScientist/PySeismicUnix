...
SUMIGTOPO2D - Kirchhoff Depth Migration of 2D postack/prestack data from the (variable topography) recording surface sumigtopo2d  infile=  outfile=  [parameters]

## Synopsis

```bash
sumigtopo2d infile=stdin		file for input seismic traces
```
