...
SUBRAID - Braid traces from files together and output. (combine multiple ordered inputs into 1 ordered output) subraid in1=filea.su in2=fileb.su in3=...   key=cdp >stdout
