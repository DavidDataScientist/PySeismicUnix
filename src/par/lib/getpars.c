...
/* Windows: Set stdin/stdout to binary mode to prevent CR/LF translation */
#ifdef _WIN32
#include <io.h>
#include <fcntl.h>
#endif
...
{
#ifdef _WIN32
	/* Set stdin/stdout/stderr to binary mode to prevent CR/LF translation */
	/* This is essential for proper handling of SU binary data in pipes */
